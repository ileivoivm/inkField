...
| 章節 | 內容 |
|------|------|
| [藝廊](#藝廊) | 瀏覽、fork、投稿錄製作品 |
| [開放創作授權](#開放創作授權) | 你能做什麼、不能做什麼 |
| [Fork — 站在別人的路徑上繼續畫](#fork--站在別人的路徑上繼續畫) | 接續別人的錄製繼續創作 |
| [關於原始碼](#關於原始碼) | 開源狀態 |
| [安裝為 App / 離線使用（PWA）](#安裝為-app--離線使用pwa) | iPad / 離線繪畫 |
| [技術文件](#技術文件) | 技術文章與 AI agent 指南 |
| [部署你的作品為 NFT](#部署你的作品為-nft) | fxhash / objkt 鑄造 |
| [URL 參數說明](#url-參數說明) | 畫布尺寸、模式、開關 |
| [介面工具（Artist 模式）](#介面工具artist-模式) | Zen Mode、Collect Panels、testMode |
| [輸出成影片](#recordvideo) | Record Video → JPG 序列 → ffmpeg |
| [支持](#支持) | 讓墨繼續流動 |
