function _j1(_j1423, _j1424) {
var _j179 = window.SHADER_SOURCES && window.SHADER_SOURCES[_j1423];
var _j180 = window.SHADER_SOURCES && window.SHADER_SOURCES[_j1424];
if (_j179 && _j180 && typeof createShader === 'function') {
return createShader(_j179, _j180);
}
return window['loadShader'](_j1423, _j1424);
}
class Crandom {
constructor() {
this.globalCount = 0;
...
for (let j = -_j488; j < _j208 + _j488; j += _j1425) {
_j211.image(_j210, i, j + (noise(i * 0.1, j * 1.0) - 0.5) * _j1426);
}
}
_j210.remove();
if (doSpotNoise) {
...
function _j10(_j1428 = 64, _j1427 = 0.5) {
const _j210 = createGraphics(_j1428, _j1428);
_j210.pixelDensity(1);
_j210.noSmooth();
_j210.clear();
_j210.noFill();
_j210.translate(_j1428 / 2, _j1428 / 2);
_j210.strokeWeight(1.5);
for (let i = 0; i < 100; i++) {
const _j214 = 0.5 + crandom.random(0, 1) * 0.5;
const _j215 = pow(_j214, _j1427) * 255;
_j210.stroke(_j215, _j215, _j215, 255);
const radius = crandom.random() * _j1428 * 0.5;
...
function _j17(_j1429, shapeData, px, py, r, g, b, alpha) {
_j1429.fill(r, g, b, alpha);
_j1429.noStroke();
const scale = 1 / _j469;
...
_j1429.vertex(px + v.x * scale, py + v.y * scale);
}
_j1429.endShape(CLOSE);
break;
case 'cluster':
...
function _j18(_j1430 = null, scanBounds = null, shapeType = null, _j1431 = null) {
let _j276 = 0;
if (typeof crandom !== 'undefined' && typeof crandom.getCount === 'function') {
_j276 = crandom.getCount();
}
const w = _j1430 ? _j1430.width : width;
const h = _j1430 ? _j1430.height : height;
const d = _j1430 ? _j1430.pixelDensity() : pixelDensity();
const _j277 = 20;
const _j278 = 700;
const _j279 = 80;
...
let pixels = null;
let targetPoints = [];
const _j283 = _j1431 && _j1431.length > 0;
if (_j283) {
for (let i = 0; i < 10; i++) {
crandom.random(0, 1);
}
targetPoints = _j1431.map(p => ({
x: p.x,
y: p.y,
brightness: p.brightness || 0
}));
} else {
const _j284 = _j1430 || window;
_j284.loadPixels();
pixels = _j1430 ? _j1430.pixels : window.pixels;
let _j285 = [];
const step = 4;
let _j286 = _j277;
let _j287 = w - _j277;
...
function _j19(_j1432 = 10, shapeType = null) {
const _j277 = 20;
const w = width;
const h = height;
let targetPoints = [];
for (let i = 0; i < _j1432; i++) {
...
window.metallicProgram.setUniform('tex0', _j1430);
...
function _j23(_j1429) {
const _j380 = typeof _j1429.begin === 'function';
if (_j380) _j1429.begin();
const g = _j380 ? window : _j1429;
g.push();
g.translate(-hw, -hh);
...
function _j26(_j1434, _j1435, name, value) {
const _j444 = _j443[_j1435];
if (_j444[name] === value) return;
_j444[name] = value;
_j1434.setUniform(name, value);
}
function _j27() {
...
function _j28(_j1429, _j1436 = 1.0) {
if (_j546) {
_j522 = true;
return;
}
...
fetch(_j666)
.then(_j1457 => {
if (!_j1457.ok) throw new Error('HTTP ' + _j1457.status);
return _j1457.json();
})
.then(data => {
_j535 = data;
...
function _j32() {
if (!_j1335.enabled) return;
_j1335.frameCount++;
let _j697 = 60;
const now = millis();
if (_j1335.lastFrameTime > 0) {
const deltaTime = now - _j1335.lastFrameTime;
...
_j1335.lastFrameTime = now;
_j1335._pushFR(_j697);
if (_j1335.frameCount - _j1335.lastCheckFrame >= _j1335.checkInterval) {
_j1335.lastCheckFrame = _j1335.frameCount;
const _j699 = _j1335._frLen > 0 ?
_j1335._avgFR() :
_j697;
if (_j1335.logFpsToConsole) {
console.log('FPS:', _j699.toFixed(1));
}
const _j700 = 0.1;
const _j701 = _j699 <= (_j1335.frameRateThreshold + _j700);
if (_j701) {
const now = millis();
if (now - _j1335.lastPerformanceLog > _j1335.logCooldown) {
_j1335.lastPerformanceLog = now;
_j33(_j699);
} else {
console.log('[性能监控] 跳过记录（冷却中，剩余:', ((_j1335.logCooldown - (now - _j1335.lastPerformanceLog)) / 1000).toFixed(1), '秒)');
}
}
}
}
function _j33(_j699) {
const _j702 = _j1335.performanceDataAccumulated;
const sampleCount = _j702.sampleCount > 0 ? _j702.sampleCount : 1;
if (sampleCount === 0 || _j702.drawTotal === 0) {
const _j703 = _j1335.performanceData;
const _j704 = _j703.drawTotal > 0 ? _j703.drawTotal : 1;
const report = {
'平均帧率': `${_j699.toFixed(1)} fps`,
'目标帧率': `${_j1335.frameRateThreshold} fps`,
...
Object.keys(_j1335.performanceData).forEach(key => {
_j1335.performanceData[key] = 0;
});
Object.keys(_j1335.performanceDataAccumulated).forEach(key => {
_j1335.performanceDataAccumulated[key] = 0;
});
}
let _j708 = 0;
const _j709 = 5;
...
if (_j710) _j1335.performanceData.updatePlayback += performance.now() - _j712;
_j24();
if (_j522 || _j511 || _j512 || _j590 || _j633) {
if (_j710) _j712 = performance.now();
updateCompositeBuffer();
if (_j710) _j1335.performanceData.updateCompositeBuffer += performance.now() - _j712;
}
...
if (_j710) _j1335.performanceData.updateEasyCamAutoTracking += performance.now() - _j712;
if (_j710) _j712 = performance.now();
drawCursorToBuffer();
if (_j710) _j1335.performanceData.drawCursorToBuffer += performance.now() - _j712;
_j34();
if (_j710) _j712 = performance.now();
updateBlurEffect();
if (_j710) _j1335.performanceData.updateBlurEffect += performance.now() - _j712;
if (_j710) _j712 = performance.now();
applyCameraProjection();
if (_j710) _j1335.performanceData.applyCameraProjection += performance.now() - _j712;
if (_j710) _j712 = performance.now();
drawLayersWithBlur();
if (_j710) _j1335.performanceData.drawLayersWithBlur += performance.now() - _j712;
_j48();
...
const _j723 = _j1335.performanceData.updatePlayback +
_j1335.performanceData.updateCompositeBuffer +
_j1335.performanceData.updateEasyCamAutoTracking +
_j1335.performanceData.drawCursorToBuffer +
_j1335.performanceData.updateBlurEffect +
_j1335.performanceData.applyCameraProjection +
_j1335.performanceData.drawLayersWithBlur;
_j1335.performanceData.other = (_j722 - _j711) - _j723;
_j1335.performanceData.drawTotal = _j722 - _j711;
_j1335.performanceDataAccumulated.drawTotal += _j1335.performanceData.drawTotal;
_j1335.performanceDataAccumulated.updatePlayback += _j1335.performanceData.updatePlayback;
_j1335.performanceDataAccumulated.updateCompositeBuffer += _j1335.performanceData.updateCompositeBuffer;
_j1335.performanceDataAccumulated.updateEasyCamAutoTracking += _j1335.performanceData.updateEasyCamAutoTracking;
_j1335.performanceDataAccumulated.drawCursorToBuffer += _j1335.performanceData.drawCursorToBuffer;
_j1335.performanceDataAccumulated.updateBlurEffect += _j1335.performanceData.updateBlurEffect;
_j1335.performanceDataAccumulated.applyCameraProjection += _j1335.performanceData.applyCameraProjection;
_j1335.performanceDataAccumulated.drawLayersWithBlur += _j1335.performanceData.drawLayersWithBlur;
_j1335.performanceDataAccumulated.other += _j1335.performanceData.other;
_j1335.performanceDataAccumulated.sampleCount++;
}
_j32();
if (_j590) {
if (_j512 && !_j601) {
...
_j997 = _j997.filter(_j1458 => _j1458.radius > 0);
}
if (!_j512) {
_j512 = true;
_j523 = 0;
...
_j474.setUniform("useSpectralMix", useSpectralMix ? 1.0 : 0.0);
noStroke();
rectMode(CENTER);
rect(0, 0, width, height);
resetShader();
...
function _j42(text, _j1437, _j1429 = null) {
let _j858 = text.split(' ');
let _j721 = [];
let _j859 = '';
for (let i = 0; i < _j858.length; i++) {
let _j860 = _j859 + (_j859 ? ' ' : '') + _j858[i];
let _j861 = _j1429 ? _j1429.textWidth(_j860) : textWidth(_j860);
if (_j861 > _j1437 && _j859) {
_j721.push(_j859);
_j859 = _j858[i];
} else {
_j859 = _j860;
...
function _j46(blendType, seed = null, _j1438 = false) {
if (!_j478) return;
_j547 = true;
_j548 = blendType;
_j549 = millis();
...
function _j50(_j1429, _j876, _j877, brushColorMode, alpha) {
if (brushColorMode === 0) {
stroke(_j876, alpha);
...
function _j51(_j1429, _j876, _j877, brushColorMode, alpha) {
if (brushColorMode === 0) {
fill(_j876, alpha);
} else if (brushColorMode === 1) {
fill(150, alpha);
...
function _j52(id, _j1429, _j959, x, y, _j920, _j921, _j913, _j914, _j934, sizeVariation, _j953) {
...
function _j53(_j1429, _j1439, _j1440) {
...
let _j880 = 0.5 * initialSize * noise(_j1439 * 0.01, _j1440 * 0.01) * (abs(_j1439 - _j878) + abs(_j1440 - _j879));
const _j881 = (_j515 && typeof _j519 !== 'undefined' && _j519 !== null) ? _j519 : baseBrushSize;
let _j882 = 0;
_j882 = min(spraySize * _j881, _j880) * map(noise(_j1439, _j1440), 0, 1, 0.3, 1);
...
const _j886 = lerp(_j1439, _j878, i / _j531)
const lerpY = lerp(_j1440, _j879, i / _j531)
for (let j = 0; j < 10; j++) {
let _j871, _j872;
...
_j51(_j1429, _j876, _j877, brushColorMode, _j895);
noStroke();
...
function _j54(_j1429, _j1439, _j1440, _j755, _j485 = 0, _j1441 = 0) {
if (_j524 >= expectedStrokeLength) {
console.log("Brush not drawn: mouseCount >= expectedStrokeLength (", _j524, ">=", expectedStrokeLength, ")");
return;
}
...
let _j913 = 0;
let _j914 = 0;
if (_j1441 == 0) showMainBrush = 0.08;
else if (_j1441 == 1) showMainBrush = 0.6;
else if (_j1441 == 2) showMainBrush = 0.2;
let _j915 = 1.0;
...
_j50(_j1429, _j876, _j877, brushColorMode, _j936);
...
if (_j933 < 5) {
let kk = 0;
if (_j1441 == 0) kk = 1.5 * min(_j912, max(_j904, _j933));
...
if (_j485 == 0) {
_j50(_j1429, _j876, _j877, brushColorMode, _j937);
if (_j941[0] > 0.2) {
...
_j50(_j1429, _j876, _j877, brushColorMode, _j938);
...
const _j948 = -1;
const _j949 = -1;
_j50(_j1429, _j876, _j877, brushColorMode, _j939);
...
_j52(
2, _j1429, _j959, x, y, _j920, _j921,
...
_j52(
3, _j1429, _j959, x, y, _j920, _j921,
_j913, _j914, _j934, sizeVariation,
_j953
);
}
...
_j50(_j1429, _j876, brushColorMode, _j937);
let _j960 = baseBrushSize * _j908;
if (baseBrushSize > 4.0) _j960 *= crandom.random(0.5, 2.5);
...
_j52(
4, _j1429, _j959, x, y, _j920, _j921,
_j913, _j914, _j934, sizeVariation,
_j953
);
}
...
function _j55(_j1429, _j1439, _j1440, _j1442 = null, _j1443 = null, n = 80, o = 2) {
_j1429.begin();
push();
translate(-hw, -hh);
const _j878 = (_j1442 !== null && _j1443 !== null) ? _j1442 : (_j590 ? _j596 : pmouseX);
const _j879 = (_j1442 !== null && _j1443 !== null) ? _j1443 : (_j590 ? _j597 : pmouseY);
...
const mouseMoved = abs(_j1439 - _j878) > 0.1 || abs(_j1440 - _j879) > 0.1;
let _j876 = _j56(_j479);
let _j877 = _j56(_j479);
const _j968 = [];
for (let i = 0; i < n; i++) {
...
let x, y;
if (mouseMoved) {
x = lerp(_j1439, _j878, t) + _j970;
y = lerp(_j1440, _j879, t) + _j971;
} else {
x = _j1439 + _j970;
y = _j1440 + _j971;
}
_j50(_j1429, _j876, _j877, brushColorMode, _j895);
...
function _j57(_j1429, _j1439, _j1440, _j755, _j485 = 0, _j1441 = 0) {
if (_j524 >= expectedStrokeLength) {
...
function _j60(_j1429, _j1439, _j1440, _j1442 = null, _j1443 = null) {
if (_j524 >= expectedStrokeLength) {
return;
}
_j1429.begin();
...
noStroke();
const _j878 = (_j1442 !== null && _j1443 !== null) ? _j1442 : (_j590 ? _j596 : pmouseX);
const _j879 = (_j1443 !== null && _j1443 !== null) ? _j1443 : (_j590 ? _j597 : pmouseY);
const _j1014 = _j1439 - _j878;
const _j1015 = _j1440 - _j879;
...
const _j1029 = _j1439 + crandom.random(-2, 2) * baseBrushSize;
const _j1030 = _j1440 + crandom.random(-2, 2) * baseBrushSize;
...
function _j61(_j1429, _j1439, _j1440, _j755, _j485 = 0, _j1441 = 0) {
if (_j524 >= expectedStrokeLength) {
console.log("Marker not drawn: mouseCount >= expectedStrokeLength (", _j524, ">=", expectedStrokeLength, ")");
return;
}
...
function _j67(panel, pos, _j1444) {
if (!panel) return;
_j1444();
...
_j1445.classList.add('panel-front');
}
function _j69() {
const _j862 = [
document.getElementById('message-overlay'),
...
function _j85(hint, _j1446) {
const button = document.getElementById(_j1446);
...
if (!_j1125) return;
_j1125.innerHTML = '';
_j639.forEach(_j1449 => {
const _j1126 = _j129(_j1449);
...
FileName: _j1292.name,
FileSize: (_j1292.size / 1024).toFixed(2) + ' KB',
Opacity: '50%',
...
const _j1145 = typeof useSpectralMix !== 'undefined' && useSpectralMix > 0;
_j1138.forEach(btn => {
const _j1143 = parseInt(btn.dataset.mode);
if (_j1145 && _j1143 === 3) {
btn.classList.add('active');
} else if (!_j1145 && _j1143 === keyBlendMode) {
btn.classList.add('active');
} else {
btn.classList.remove('active');
}
...
brushColorMode = _j1147[color] !== undefined ? _j1147[color] : 0;
_j119();
_j122();
const _j1148 = {
'black': 'Black',
...
const _j1149 = _j8(color);
if (_j1149) {
const _j1150 = document.getElementById('custom-brush-color');
const _j1151 = document.getElementById('custom-brush-color-text');
if (_j1150) _j1150.value = _j1149.hex;
if (_j1151) _j1151.value = _j1149.displayName + ' ' + _j1149.hex;
if (typeof customBrushColor !== 'undefined') {
customBrushColor[0] = _j1149.rgb[0];
customBrushColor[1] = _j1149.rgb[1];
customBrushColor[2] = _j1149.rgb[2];
}
}
}
_j100('ui', '🎨 Brush color changed', {
Color: _j1148[color] || color,
Mode: `${_j1148[color] || color} brush mode`,
ColorCode: brushColorMode
});
}
function _j119() {
const _j1152 = document.querySelectorAll('.brush-color-btn');
const _j1153 = document.querySelectorAll('.color-swatch');
if (_j1152.length === 0 && _j1153.length === 0) {
...
const _j1155 = (brushColorMode === 33);
const _j1156 = _j1155 ? null : (_j1154[brushColorMode] || 'black');
_j1152.forEach(btn => {
btn.classList.remove('active');
if (!_j1155 && btn.dataset.color === _j1156) {
btn.classList.add('active');
}
});
_j1153.forEach(btn => {
...
function _j120(_j1182) {
_j530 = parseInt(_j1182);
_j121();
_j122();
const _j1157 = {
1: '2-6',
...
function _j122() {
const _j1158 = document.getElementById('current-brush-mode');
if (_j1158) {
_j1158.textContent = brushMode;
}
const _j1159 = document.getElementById('current-brush-size');
if (_j1159) {
const _j1160 = {
'extra-small': 'XS',
'small': 'S',
...
_j1159.textContent = _j1160[_j497] || 'M';
}
const _j1161 = document.getElementById('current-ink-effect');
if (_j1161) {
const _j1162 = {
0: 'MIX',
1: 'SHARP',
...
_j1161.textContent = _j1162[useSharpen] || 'MIX';
}
const _j1163 = document.getElementById('current-brush-color');
if (_j1163) {
const _j1164 = {
0: 'Black',
1: 'White',
...
_j1163.textContent = _j1164[brushColorMode] || 'Black';
}
}
function _j123() {
brushMode = 1;
...
const _j1165 = 300;
_j1447.addEventListener('touchstart', (e) => {
const now = Date.now();
const _j1166 = window._elementLastTriggerTime.get(_j1447) || 0;
if (now - _j1166 < _j1165) {
e.preventDefault();
e.stopPropagation();
return;
}
window._elementTouchHandled.set(_j1447, true);
setTimeout(() => {
window._elementTouchHandled.delete(_j1447);
}, _j1165);
window._elementLastTriggerTime.set(_j1447, now);
e.stopPropagation();
e.preventDefault();
_j1448(e);
}, {
...
_j1447.addEventListener('click', (e) => {
if (window._elementTouchHandled && window._elementTouchHandled.get(_j1447)) {
e.preventDefault();
e.stopPropagation();
return;
}
...
_j1447.addEventListener('mousedown', (e) => {
if (e.button === 0) {
e.stopPropagation();
}
});
...
function _j125() {
const _j1167 = document.getElementById('canvas-background-color');
const _j1168 = document.getElementById('canvas-background-color-text');
if (!_j1167 || !_j1168) {
return;
}
if (typeof canvasBackgroundColor !== 'undefined') {
...
const _j1169 = `#${r}${g}${b}`.toUpperCase();
_j1167.value = _j1169;
_j1168.value = _j1169;
}
}
function _j126() {
const _j1170 = document.getElementById('canvas-width');
const _j1171 = document.getElementById('canvas-height');
if (!_j1170 || !_j1171) {
return;
}
...
function _j127() {
const _j1172 = typeof window !== 'undefined' && window.APP_MODE ? window.APP_MODE : 'artist';
const _j1173 = _j1172 === 'collector';
if (_j1173) {
...
const _j1174 = document.querySelectorAll('.brush-mode-btn');
_j1174.forEach(btn => {
_j124(btn, () => {
...
const _j1175 = document.querySelectorAll('.brush-size-btn');
_j1175.forEach(btn => {
_j124(btn, () => {
const _j1176 = btn.dataset.size;
_j109(_j1176);
});
});
const _j1177 = document.querySelectorAll('.ink-effect-btn');
_j1177.forEach(btn => {
_j124(btn, () => {
...
const _j1178 = document.querySelectorAll('.brush-color-btn, .color-swatch');
_j1178.forEach(btn => {
_j124(btn, () => {
...
const _j1179 = document.getElementById('custom-brush-color');
const _j1180 = document.getElementById('custom-brush-color-text');
if (_j1179 && _j1180) {
_j1179.addEventListener('input', (e) => {
_j1180.value = e.target.value.toUpperCase();
_j147();
});
_j1179.addEventListener('change', (e) => {
_j1180.value = e.target.value.toUpperCase();
_j147();
});
_j1180.addEventListener('input', (e) => {
const _j1169 = e.target.value.trim();
if (/^#[0-9A-Fa-f]{6}$/.test(_j1169)) {
_j1179.value = _j1169.toUpperCase();
}
});
_j1180.addEventListener('keypress', (e) => {
if (e.key === 'Enter') {
_j147();
}
});
}
const _j1181 = document.querySelectorAll('.path-rotation-btn');
_j1181.forEach(btn => {
_j124(btn, () => {
const _j1182 = btn.dataset.rotation;
_j120(_j1182);
});
});
const _j1183 = document.querySelectorAll('.blendmode-btn');
_j1183.forEach(btn => {
_j124(btn, () => {
const mode = btn.dataset.mode;
_j115(mode);
...
const _j1184 = document.getElementById('clear-canvas');
if (_j1184) {
_j124(_j1184, () => {
_j153();
...
_j1168.value = e.target.value.toUpperCase();
});
_j1167.addEventListener('change', (e) => {
_j1168.value = e.target.value.toUpperCase();
_j148();
});
_j1168.addEventListener('input', (e) => {
const _j1169 = e.target.value.trim();
if (/^#[0-9A-Fa-f]{6}$/.test(_j1169)) {
_j1167.value = _j1169.toUpperCase();
}
});
_j1168.addEventListener('keypress', (e) => {
if (e.key === 'Enter') {
_j148();
}
});
...
_j1171.addEventListener('keypress', (e) => {
if (e.key === 'Enter') {
_j148();
}
});
...
const _j1185 = document.getElementById('panel-scale-slider');
if (_j1185) {
_j1185.value = (typeof window.panelScale !== 'undefined') ? window.panelScale : 0.8;
_j1185.addEventListener('input', (e) => {
...
const _j1186 = document.getElementById('toggle-control-panel');
if (_j1186) {
_j124(_j1186, _j92);
}
const controlPanel = _j63('controlPanel');
...
const _j1188 = effectControlPanel?.querySelector('.effect-control-panel-header');
if (_j1188) {
_j1188.addEventListener('mousedown', _j75);
_j1188.addEventListener('touchstart', (e) => {
const _j1112 = e.touches[0];
const _j1187 = {
clientX: _j1112.clientX,
clientY: _j1112.clientY,
...
const _j1189 = document.getElementById('toggle-effect-control-panel');
if (_j1189) {
_j124(_j1189, _j93);
}
const flowEffectPanel = _j63('flowEffectPanel');
const _j1190 = flowEffectPanel?.querySelector('.flow-effect-panel-header');
if (_j1190) {
_j1190.addEventListener('mousedown', _j79);
_j1190.addEventListener('touchstart', (e) => {
const _j1112 = e.touches[0];
const _j1187 = {
clientX: _j1112.clientX,
clientY: _j1112.clientY,
...
const _j1191 = document.getElementById('toggle-flow-effect-panel');
if (_j1191) {
_j124(_j1191, _j94);
}
...
function _j128() {
const now = millis();
const _j1192 = (now - _j1131) >= _j1132;
...
if (_j1192) {
const _j1193 = loopWaitDuration - (millis() - _j599);
const _j1194 = Math.ceil(_j1193 / 1000);
const _j785 = _j1193 / loopWaitDuration;
if (window.DEBUG_MODE && _j1194 !== _j1130) {
console.log(`Countdown: ${_j1194}s remaining (${Math.floor(_j785 * 100)}%)`);
_j1130 = _j1194;
}
const countdownText = _j63('countdownText');
if (countdownText) {
countdownText.textContent = `Waiting ${_j1194}s`;
}
const countdownCircle = _j63('countdownCircle');
if (countdownCircle) {
const _j1195 = 62.83;
const _j1196 = _j1195 * (1 - _j785);
countdownCircle.style.strokeDashoffset = _j1196;
}
}
} else {
_j1130 = -1;
...
const _j1197 = Math.round(_j399 * 100);
if (_j1197 !== _j1133) {
const progressFill = _j63('progressFill');
const progressText = _j63('progressText');
if (progressFill) progressFill.style.width = `${_j1197}%`;
if (progressText) progressText.textContent = `${_j1197}%`;
_j1133 = _j1197;
}
}
}
...
function _j129(_j1449) {
const _j1198 = document.createElement('div');
_j1198.className = 'message-item new-message';
const _j1199 = document.createElement('span');
_j1199.className = 'message-icon';
_j1199.textContent = _j1449.icon;
const _j1200 = document.createElement('div');
_j1200.className = 'message-content';
const _j1201 = document.createElement('div');
_j1201.className = 'message-header';
const _j1202 = document.createElement('span');
_j1202.className = 'message-timestamp';
_j1202.textContent = _j1449.timestamp;
const _j1203 = document.createElement('span');
_j1203.className = `message-type ${_j1449.type}`;
_j1203.textContent = _j1449.type.toUpperCase();
_j1201.appendChild(_j1202);
_j1201.appendChild(_j1203);
const _j1204 = document.createElement('p');
_j1204.className = 'message-text';
_j1204.textContent = _j1449.message;
_j1200.appendChild(_j1201);
_j1200.appendChild(_j1204);
if (Object.keys(_j1449.data).length > 0) {
const _j1205 = document.createElement('div');
_j1205.className = 'message-data';
_j1205.textContent = JSON.stringify(_j1449.data, null, 2);
_j1200.appendChild(_j1205);
}
_j1198.appendChild(_j1199);
_j1198.appendChild(_j1200);
setTimeout(() => {
_j1198.classList.remove('new-message');
}, 300);
return _j1198;
}
function _j130() {
...
function _j132() {
const _j1206 = document.getElementById('record-status-text');
if (_j1206) {
if (_j589 == 1) {
_j1206.textContent = 'ON';
_j1206.classList.add('active');
} else {
_j1206.textContent = 'OFF';
_j1206.classList.remove('active');
}
}
}
function _j133() {
const _j1207 = {};
const _j1208 = window.location.search;
if (!_j1208 || _j1208.length <= 1) {
return _j1207;
}
const _j1209 = _j1208.substring(1);
const _j969 = _j1209.split('_');
const _j1210 = {
'wd': true,
'gr': true
};
for (const _j1211 of _j969) {
if (!_j1211) continue;
const _j1212 = _j1211.indexOf(':');
if (_j1212 === -1) continue;
const key = _j1211.substring(0, _j1212);
const value = _j1211.substring(_j1212 + 1);
if (key) {
if (key === 'w' || key === 'h') {
const _j1213 = parseInt(value);
...
if (_j1210[key]) {
const _j1214 = parseFloat(value);
if (!isNaN(_j1214) && _j1214 > 0) {
_j1207[key] = true;
_j1207[key + '_val'] = _j1214;
} else {
_j1207[key] = false;
}
} else {
...
for (const [_j1211, toggleId] of Object.entries(_j1215)) {
if (_j1450.hasOwnProperty(_j1211)) {
if (_j1211 === 'loop' && window.APP_MODE === 'collector') {
if (window.DEBUG_MODE) console.log('🔒 Collector 模式：忽略 URL 参数中的 loop 设置，保持 loopToggle = 1');
continue;
}
const _j1216 = _j1450[_j1211];
const _j1217 = document.getElementById(toggleId);
if (_j1217) {
_j1217.checked = _j1216;
_j1217.dispatchEvent(new Event('change'));
if (_j1211 === 'rs') {
const _j1218 = document.getElementById('rs-sliders-section');
if (_j1218) {
_j1218.style.display = _j1216 ? 'flex' : 'none';
}
} else if (_j1211 === 'distort') {
const _j1219 = document.getElementById('distort-sliders-section');
if (_j1219) {
_j1219.style.display = _j1216 ? 'flex' : 'none';
}
} else if (_j1211 === 'cl') {
const _j1220 = document.getElementById('cellular-sliders-section');
if (_j1220) {
_j1220.style.display = _j1216 ? 'flex' : 'none';
}
} else if (_j1211 === 'wd') {
const _j1221 = document.getElementById('white-dot-sliders-section');
if (_j1221) {
_j1221.style.display = _j1216 ? 'flex' : 'none';
}
if (_j1216 && _j1450['wd_val'] !== undefined) {
const _j1222 = document.getElementById('white-dot-density');
const _j1223 = document.getElementById('white-dot-density-value');
if (_j1222) _j1222.value = _j1450['wd_val'];
if (_j1223) _j1223.textContent = _j1450['wd_val'].toFixed(2);
}
} else if (_j1211 === 'gr') {
const _j1224 = document.getElementById('grain-sliders-section');
if (_j1224) {
_j1224.style.display = _j1216 ? 'flex' : 'none';
}
if (_j1216 && _j1450['gr_val'] !== undefined) {
const _j1225 = document.getElementById('grain-amount');
const _j1226 = document.getElementById('grain-amount-value');
if (_j1225) _j1225.value = _j1450['gr_val'];
if (_j1226) _j1226.textContent = _j1450['gr_val'].toFixed(2);
}
}
} else {
console.warn(`  ⚠️ Toggle not found: ${toggleId} for param: ${_j1211}`);
}
}
}
}
...
if (_j1227['w']) window._urlCanvasWidth = _j1227['w'];
if (_j1227['h']) window._urlCanvasHeight = _j1227['h'];
if (Object.keys(_j1227).length > 0) {
console.log('🔗 檢測到 URL 參數，只設定 URL 有指定的開關');
for (const [_j1211, _j1216] of Object.entries(_j1227)) {
const globalVarName = _j1228[_j1211];
if (globalVarName && typeof window[globalVarName] !== 'undefined') {
if (_j1211 === 'loop') {
window[globalVarName] = _j1216 ? 1 : 0;
} else {
window[globalVarName] = _j1216;
}
}
}
const _j1229 = {
...
for (const [_j1211, globalVarName] of Object.entries(_j1229)) {
const valKey = _j1211 + '_val';
if (_j1227[valKey] !== undefined) {
window[globalVarName] = _j1227[valKey];
window[_j1230[_j1211]] = _j1227[valKey];
}
}
window._initialConsoleFromURL = _j1227.hasOwnProperty('console') ? _j1227.console : false;
}
const _j1172 = typeof window !== 'undefined' && window.APP_MODE ? window.APP_MODE : 'artist';
const _j1173 = _j1172 === 'collector';
const _j1186 = document.getElementById('toggle-overlay');
const _j1231 = document.getElementById('toggle-hint-btn');
const _j1232 = document.getElementById('clear-bite-points');
const _j1233 = document.getElementById('scan-global');
const _j1234 = document.getElementById('scan-current');
const _j1235 = document.getElementById('scan-random');
const _j1236 = document.getElementById('scan-current-random');
const _j1237 = document.getElementById('brush-hint-btn');
const _j1238 = document.querySelectorAll('input[name="pixel-density"]');
if (_j1238.length > 0) {
let _j1239 = 2;
if (typeof _j469 !== 'undefined') {
_j1239 = _j469;
}
const _j1240 = document.querySelector(`input[name="pixel-density"][value="${_j1239}"]`);
if (_j1240) {
_j1240.checked = true;
}
_j1238.forEach(_j1456 => {
_j1456.addEventListener('change', (e) => {
if (e.target.checked) {
...
if (_j1173) {
if (_j1237) _j1237.style.display = 'none';
}
const _j1241 = document.getElementById('record-toggle');
const _j1206 = document.getElementById('record-status-text');
const _j1242 = document.getElementById('realtime-drawing-toggle');
const _j1243 = document.getElementById('realtime-drawing-status-text');
const _j1244 = document.getElementById('grid-overlay-toggle');
const _j1245 = document.getElementById('paper-texture-toggle');
const _j1246 = document.getElementById('camera-moving-toggle');
const _j1247 = document.getElementById('loop-toggle');
const overlay = document.getElementById('message-overlay');
const hint = document.getElementById('toggle-hint');
...
const _j1248 = document.getElementById('effect-hint-btn');
if (_j1248) {
_j124(_j1248, () => {
if (!_j84()) _j93();
});
}
const _j1249 = document.getElementById('flow-hint-btn');
if (_j1249) {
_j124(_j1249, () => {
if (!_j84()) _j94();
});
...
const _j1250 = document.getElementById('stroke-select-slider');
if (_j1250) {
_j299 = parseInt(_j1250.value) || 0;
...
_j124(_j1236, () => {
if (typeof _j532 !== 'undefined' && _j532.length > 0) {
const _j1251 = Math.floor(Math.random() * _j532.length);
const _j1250 = document.getElementById('stroke-select-slider');
const _j1252 = document.getElementById('stroke-index-display');
const _j1253 = document.getElementById('stroke-select-value');
if (_j1250) {
_j1250.value = _j1251;
_j1250.dispatchEvent(new Event('input', {
bubbles: true
}));
}
if (_j1252) {
_j1252.textContent = _j1251;
}
if (_j1253) {
_j1253.textContent = _j1251;
}
_j100('system', `🎲 EACHR: 随机选择笔画 #${_j1251}`, {
RandomIndex: _j1251,
TotalStrokes: _j532.length
});
_j136(_j1251);
...
if (_j1242) {
_j1242.disabled = true;
if (_j1243) {
_j1243.textContent = 'DISABLED';
}
...
_j1244.checked = !!showGridOverlay;
}
} catch (e) {}
...
_j1245.checked = !!showPaperTexture;
} else {
_j1245.checked = true;
}
} catch (e) {
...
const _j1254 = document.getElementById('fit-canvas-toggle');
if (_j1254) {
...
_j1247.checked = (loopToggle === 1);
} else {
_j1247.checked = false;
}
} catch (e) {
_j1247.checked = false;
}
_j1247.addEventListener('change', (e) => {
...
console.error('Error setting loopToggle:', _j1460);
}
});
}
const _j1255 = document.getElementById('playback-offset-x');
const _j1256 = document.getElementById('playback-offset-y');
if (_j1255) {
...
_j1256.addEventListener('input', (e) => {
const value = parseFloat(e.target.value) || 0;
if (typeof _j603 !== 'undefined') {
_j603 = value;
...
const _j1257 = document.getElementById('distort-shader-toggle');
const _j1219 = document.getElementById('distort-sliders-section');
if (_j1257) {
try {
if (typeof distortShaderEnabled !== 'undefined') {
_j1257.checked = !!distortShaderEnabled;
if (_j1219) {
_j1219.style.display = distortShaderEnabled ? 'flex' : 'none';
}
} else {
_j1257.checked = false;
if (_j1219) {
_j1219.style.display = 'none';
}
}
} catch (e) {
_j1257.checked = false;
...
_j1257.addEventListener('change', (e) => {
const enabled = !!e.target.checked;
try {
if (typeof distortShaderEnabled !== 'undefined') {
...
console.error('Error setting distortShaderEnabled:', _j1460);
}
});
}
const _j1258 = document.getElementById('distort-displacement-b');
const _j1259 = document.getElementById('distort-displacement-b-value');
if (_j1258 && _j1259) {
const _j1260 = parseFloat(_j1258.value);
if (typeof distortDisplacementB !== 'undefined') {
distortDisplacementB = _j1260;
}
_j1259.textContent = Math.round(_j1260);
_j1258.addEventListener('input', (e) => {
const value = parseFloat(e.target.value);
if (typeof distortDisplacementB !== 'undefined') {
distortDisplacementB = value;
}
_j1259.textContent = Math.round(value);
});
}
const _j1261 = document.getElementById('distort-displacement-c');
const _j1262 = document.getElementById('distort-displacement-c-value');
if (_j1261 && _j1262) {
const _j1260 = parseFloat(_j1261.value);
if (typeof distortDisplacementC !== 'undefined') {
distortDisplacementC = _j1260;
}
_j1262.textContent = Math.round(_j1260);
_j1261.addEventListener('input', (e) => {
const value = parseFloat(e.target.value);
if (typeof distortDisplacementC !== 'undefined') {
distortDisplacementC = value;
}
_j1262.textContent = Math.round(value);
});
}
const _j1263 = document.getElementById('distort-fbm-preview-toggle');
if (_j1263) {
try {
if (typeof distortShowFbmMask !== 'undefined') {
_j1263.checked = (distortShowFbmMask > 0.5);
} else {
...
console.error('Error setting distortShowFbmMask:', _j1460);
}
});
}
const _j1264 = document.getElementById('rs-toggle');
const _j1218 = document.getElementById('rs-sliders-section');
if (_j1264) {
try {
if (typeof rsEnabled !== 'undefined') {
_j1264.checked = !!rsEnabled;
if (_j1218) {
_j1218.style.display = rsEnabled ? 'flex' : 'none';
}
} else {
_j1264.checked = false;
if (_j1218) {
...
_j1264.addEventListener('change', (e) => {
const enabled = !!e.target.checked;
try {
if (typeof rsEnabled !== 'undefined') {
rsEnabled = enabled;
...
console.error('Error setting rsEnabled:', _j1460);
}
});
}
const _j1265 = document.getElementById('rs-frequency');
const _j1266 = document.getElementById('rs-frequency-value');
if (_j1265 && _j1266) {
const _j1260 = parseFloat(_j1265.value);
if (typeof _j537 !== 'undefined') {
_j537 = _j1260;
}
_j1266.textContent = Math.round(_j1260);
_j1265.addEventListener('input', (e) => {
const value = parseFloat(e.target.value);
if (typeof _j537 !== 'undefined') {
_j537 = value;
}
_j1266.textContent = Math.round(value);
});
}
const _j1267 = document.getElementById('rs-wave-speed');
const _j1268 = document.getElementById('rs-wave-speed-value');
if (_j1267 && _j1268) {
const _j1260 = parseFloat(_j1267.value);
if (typeof _j538 !== 'undefined') {
_j538 = _j1260;
}
_j1268.textContent = _j1260.toFixed(1);
_j1267.addEventListener('input', (e) => {
const value = parseFloat(e.target.value);
if (typeof _j538 !== 'undefined') {
_j538 = value;
}
_j1268.textContent = value.toFixed(1);
});
}
const _j1269 = document.getElementById('rs-strength');
const _j1270 = document.getElementById('rs-strength-value');
if (_j1269 && _j1270) {
const _j1260 = parseFloat(_j1269.value);
if (typeof _j539 !== 'undefined') {
_j539 = _j1260;
}
_j1270.textContent = _j1260.toFixed(1);
_j1269.addEventListener('input', (e) => {
const value = parseFloat(e.target.value);
if (typeof _j539 !== 'undefined') {
_j539 = value;
}
_j1270.textContent = value.toFixed(1);
});
}
const _j1271 = document.getElementById('rs-gradient-mix');
const _j1272 = document.getElementById('rs-gradient-mix-value');
if (_j1271 && _j1272) {
const _j1260 = parseFloat(_j1271.value);
if (typeof _j540 !== 'undefined') {
_j540 = _j1260;
}
_j1272.textContent = _j1260.toFixed(1);
_j1271.addEventListener('input', (e) => {
const value = parseFloat(e.target.value);
if (typeof _j540 !== 'undefined') {
_j540 = value;
}
_j1272.textContent = value.toFixed(1);
});
}
const _j1273 = document.getElementById('rs-scale');
const _j1274 = document.getElementById('rs-scale-value');
if (_j1273 && _j1274) {
const _j1260 = parseFloat(_j1273.value);
if (typeof _j541 !== 'undefined') {
_j541 = _j1260;
}
_j1274.textContent = Math.round(_j1260);
_j1273.addEventListener('input', (e) => {
const value = parseFloat(e.target.value);
if (typeof _j541 !== 'undefined') {
_j541 = value;
}
_j1274.textContent = Math.round(value);
});
}
const _j1275 = document.getElementById('cellular-toggle');
const _j1220 = document.getElementById('cellular-sliders-section');
if (_j1275) {
try {
if (typeof cellularEnabled !== 'undefined') {
_j1275.checked = !!cellularEnabled;
if (_j1220) {
_j1220.style.display = cellularEnabled ? 'flex' : 'none';
}
} else {
_j1275.checked = false;
if (_j1220) _j1220.style.display = 'none';
}
} catch (e) {
_j1275.checked = false;
if (_j1220) _j1220.style.display = 'none';
}
_j1275.addEventListener('change', (e) => {
const enabled = !!e.target.checked;
try {
if (typeof cellularEnabled !== 'undefined') {
cellularEnabled = enabled;
if (_j1220) {
_j1220.style.display = enabled ? 'flex' : 'none';
}
...
console.error('Error setting cellularEnabled:', _j1460);
}
});
}
const _j1276 = document.getElementById('cellular-scale');
const _j1277 = document.getElementById('cellular-scale-value');
if (_j1276 && _j1277) {
const _j1260 = parseFloat(_j1276.value);
if (typeof _j542 !== 'undefined') _j542 = _j1260;
_j1277.textContent = _j1260.toFixed(1);
_j1276.addEventListener('input', (e) => {
const value = parseFloat(e.target.value);
if (typeof _j542 !== 'undefined') _j542 = value;
_j1277.textContent = value.toFixed(1);
});
}
const _j1278 = document.getElementById('cellular-seed');
const _j1279 = document.getElementById('cellular-seed-value');
if (_j1278 && _j1279) {
const _j1260 = parseFloat(_j1278.value);
if (typeof _j543 !== 'undefined') _j543 = _j1260;
_j1279.textContent = _j1260.toFixed(1);
_j1278.addEventListener('input', (e) => {
const value = parseFloat(e.target.value);
if (typeof _j543 !== 'undefined') _j543 = value;
_j1279.textContent = value.toFixed(1);
});
}
const _j1280 = document.getElementById('white-dot-toggle');
const _j1281 = document.getElementById('white-dot-sliders-section');
if (_j1280) {
try {
if (typeof whiteDotEnabled !== 'undefined') {
_j1280.checked = !!whiteDotEnabled;
if (_j1281) _j1281.style.display = whiteDotEnabled ? 'flex' : 'none';
} else {
_j1280.checked = false;
if (_j1281) _j1281.style.display = 'none';
}
} catch (e) {
_j1280.checked = false;
if (_j1281) _j1281.style.display = 'none';
}
_j1280.addEventListener('change', (e) => {
const enabled = !!e.target.checked;
try {
if (typeof whiteDotEnabled !== 'undefined') {
whiteDotEnabled = enabled;
if (_j1281) _j1281.style.display = enabled ? 'flex' : 'none';
_j100('system', 'White Dot', {
Status: enabled ? 'Enabled' : 'Disabled'
});
}
} catch (_j1460) {
console.error('Error setting whiteDotEnabled:', _j1460);
}
});
}
const _j1282 = document.getElementById('white-dot-density');
const _j1283 = document.getElementById('white-dot-density-value');
if (_j1282 && _j1283) {
if (window._urlParamWdVal !== undefined) {
const _j1284 = window._urlParamWdVal;
_j544 = _j1284 * 0.1;
_j1282.value = _j1284;
_j1283.textContent = _j1284.toFixed(2);
} else {
const _j1284 = parseFloat(_j1282.value);
if (typeof _j544 !== 'undefined') _j544 = _j1284 * 0.1;
_j1283.textContent = _j1284.toFixed(2);
}
_j1282.addEventListener('input', (e) => {
const _j1284 = parseFloat(e.target.value);
if (typeof _j544 !== 'undefined') _j544 = _j1284 * 0.1;
_j1283.textContent = _j1284.toFixed(2);
});
}
const _j1285 = document.getElementById('grain-toggle');
const _j1286 = document.getElementById('grain-sliders-section');
if (_j1285) {
try {
if (typeof grainEnabled !== 'undefined') {
_j1285.checked = !!grainEnabled;
if (_j1286) _j1286.style.display = grainEnabled ? 'flex' : 'none';
} else {
_j1285.checked = false;
if (_j1286) _j1286.style.display = 'none';
}
} catch (e) {
_j1285.checked = false;
if (_j1286) _j1286.style.display = 'none';
}
_j1285.addEventListener('change', (e) => {
const enabled = !!e.target.checked;
try {
if (typeof grainEnabled !== 'undefined') {
grainEnabled = enabled;
if (_j1286) _j1286.style.display = enabled ? 'flex' : 'none';
_j100('system', 'Grain', {
Status: enabled ? 'Enabled' : 'Disabled'
});
}
} catch (_j1460) {
console.error('Error setting grainEnabled:', _j1460);
}
});
}
const _j1287 = document.getElementById('grain-amount');
const _j1288 = document.getElementById('grain-amount-value');
if (_j1287 && _j1288) {
if (window._urlParamGrVal !== undefined) {
const _j1284 = window._urlParamGrVal;
_j545 = _j1284 * 0.1;
_j1287.value = _j1284;
_j1288.textContent = _j1284.toFixed(2);
} else {
const _j1284 = parseFloat(_j1287.value);
if (typeof _j545 !== 'undefined') _j545 = _j1284 * 0.1;
_j1288.textContent = _j1284.toFixed(2);
}
_j1287.addEventListener('input', (e) => {
const _j1284 = parseFloat(e.target.value);
if (typeof _j545 !== 'undefined') _j545 = _j1284 * 0.1;
_j1288.textContent = _j1284.toFixed(2);
});
}
const _j1289 = document.getElementById('future-path-preview-toggle');
if (_j1289) {
try {
if (typeof showFuturePathPreview !== 'undefined') {
_j1289.checked = !!showFuturePathPreview;
} else {
_j1289.checked = true;
}
} catch (e) {
...
console.error('Error setting showFuturePathPreview:', _j1460);
}
});
}
if (recordBtn) {
...
const _j1290 = document.getElementById('load-image');
const _j1291 = document.getElementById('image-file-input');
if (_j1173) {
if (_j1290) _j1290.style.display = 'none';
} else if (_j1290 && _j1291) {
_j124(_j1290, () => {
_j1291.click();
});
_j1291.addEventListener('change', (e) => {
const _j1292 = e.target.files[0];
if (_j1292 && _j1292.type.startsWith('image/')) {
_j105(_j1292);
}
});
}
const _j1293 = document.getElementById('show-reference-image');
if (_j1293 && !_j1173) {
_j124(_j1293, () => {
_j106();
});
}
const _j1294 = document.getElementById('hide-reference-image');
if (_j1294 && !_j1173) {
_j124(_j1294, () => {
_j107();
});
...
_j69();
const _j1295 = _j63('flowEffectPanel');
if (_j1295 && !_j1295.querySelector('.panel-drag-handle')) {
...
_j1295.appendChild(dh);
}
document.querySelectorAll('.panel-drag-handle').forEach(_j1459 => {
const _j1296 = _j1459.getAttribute('data-panel');
const _j1297 = {
overlay: _j64,
control: _j71,
effect: _j75,
...
const fn = _j1297[_j1296];
if (!fn) return;
_j1459.addEventListener('mousedown', (e) => {
e.preventDefault();
fn(e);
});
_j1459.addEventListener('touchstart', (e) => {
const _j1112 = e.touches[0];
fn({ clientX: _j1112.clientX, clientY: _j1112.clientY, target: _j1459, closest: () => null, preventDefault: () => e.preventDefault() });
}, { passive: false });
});
...
if (_j1189) {
_j1189.textContent = _j650 ? 'Hide' : 'Show';
}
}
const flowEffectPanel = _j63('flowEffectPanel');
const flowHint = _j63('flowHint');
...
if (_j1191) {
_j1191.textContent = _j654 ? 'Hide' : 'Show';
}
}
if (Object.keys(_j1227).length > 0) {
setTimeout(() => {
...
Parameters: Object.keys(_j1227).length
});
}, 200);
}
setTimeout(() => {
...
const _j1300 = document.getElementById('effect-control-panel');
const _j1295 = document.getElementById('flow-effect-panel');
const _j1301 = document.querySelectorAll('#toggle-hint, #brush-hint, #effect-hint, #flow-hint');
...
if (_j1300) _j1300.style.display = 'none';
if (_j1295) _j1295.style.display = 'none';
_j1301.forEach(h => h.style.display = 'none');
_j638 = false;
_j646 = false;
_j650 = false;
_j654 = false;
...
const s = _j1299 || { overlay: true, control: true, effect: true, flow: true };
_j638 = s.overlay;
_j646 = s.control;
_j650 = s.effect;
_j654 = s.flow;
...
if (_j1300) _j1300.style.display = s.effect ? 'block' : 'none';
if (_j1295) _j1295.style.display = s.flow ? 'block' : 'none';
_j1301.forEach(h => h.style.display = '');
if (s.overlay) {
...
_j1302.forEach(({ panel, pos, update, defaultPos }) => {
...
if (go()) return;
let _j1303 = false;
const _j1304 = new MutationObserver(() => {
if (_j1303) return;
if (go()) {
_j1303 = true;
_j1304.disconnect();
...
_j1304.observe(document.body, {
childList: true,
subtree: true
});
setTimeout(() => {
if (!_j1303) _j1304.disconnect();
}, 15000);
}
window.scheduleMobilePhoneZenMode = scheduleMobilePhoneZenMode;
function _j140() {
const _j1305 = document.getElementById('metallic-strength');
const _j1306 = document.getElementById('metallic-strength-value');
if (_j1305 && _j1306) {
const _j1260 = parseFloat(_j1305.value);
if (typeof window.metallicStrength !== 'undefined') {
window.metallicStrength = _j1260 / 100;
}
_j1306.textContent = _j1260;
_j1305.addEventListener('input', (e) => {
const value = parseFloat(e.target.value);
if (typeof window.metallicStrength !== 'undefined') {
window.metallicStrength = value / 100;
}
_j1306.textContent = value;
if (typeof _j168 === 'function' && typeof _j582 !== 'undefined' && _j582) {
_j168('ec', {
...
const _j1307 = document.getElementById('metallic-flow');
const _j1308 = document.getElementById('metallic-flow-value');
const _j1309 = document.getElementById('flow-auto-random');
let _j1310 = null;
if (_j1307 && _j1308) {
const _j1260 = parseFloat(_j1307.value);
if (typeof window.metallicFlowSpeed !== 'undefined') {
window.metallicFlowSpeed = _j1260 / 100;
}
_j1308.textContent = _j1260;
...
if (_j1309 && _j1307 && _j1308) {
_j1309.addEventListener('click', () => {
const isActive = _j1309.getAttribute('data-active') === 'true';
if (isActive) {
_j1309.setAttribute('data-active', 'false');
_j1309.classList.remove('active');
if (_j1310) {
clearInterval(_j1310);
_j1310 = null;
}
console.log('🎲 Flow 自动随机：关闭');
} else {
_j1309.setAttribute('data-active', 'true');
_j1309.classList.add('active');
_j1310 = setInterval(() => {
const _j298 = Math.floor(Math.random() * (300 - 10 + 1)) + 10;
_j1307.value = _j298;
_j1308.textContent = _j298;
if (typeof window.metallicFlowSpeed !== 'undefined') {
...
Object.keys(tintButtons).forEach(_j1368 => {
const _j1311 = document.getElementById(_j1368);
if (_j1311) {
_j1311.classList.remove('active');
}
});
btn.classList.add('active');
const _j1312 = btn.textContent.trim();
...
function _j142() {
const _j1313 = document.querySelector('.shape-type-btn.active');
if (_j1313) {
return parseInt(_j1313.dataset.type);
}
return 0;
}
function _j143(type) {
...
_j1138.forEach(btn => {
const _j1314 = parseInt(btn.dataset.type);
if (_j1314 === type) {
btn.classList.add('active');
} else {
btn.classList.remove('active');
...
function _j144() {
const _j761 = document.getElementById('bugs-size');
const _j1315 = document.getElementById('bugs-size-value');
if (_j761 && _j1315) {
const _j1260 = parseFloat(_j761.value);
if (typeof window.bugsSize !== 'undefined') {
window.bugsSize = _j1260;
}
_j1315.textContent = _j1260;
_j761.addEventListener('input', (e) => {
const value = parseFloat(e.target.value);
window.bugsSize = value;
_j1315.textContent = value;
if (typeof _j168 === 'function' && typeof _j582 !== 'undefined' && _j582) {
_j168('ec', {
action: 'bugs-size',
value: value
...
const _j1316 = document.querySelectorAll('.shape-type-btn');
_j1316.forEach(btn => {
_j124(btn, () => {
...
const _j1250 = document.getElementById('stroke-select-slider');
const _j1252 = document.getElementById('stroke-index-display');
const _j1317 = document.getElementById('stroke-total-display');
const _j1253 = document.getElementById('stroke-select-value');
if (!_j1250 || !_j1252 || !_j1317 || !_j1253) {
return;
}
function _j146(_j1451 = false) {
const _j846 = (typeof _j532 !== 'undefined' && Array.isArray(_j532)) ?
_j532.length :
0;
const _j1318 = Math.max(0, _j846 - 1);
_j1250.max = _j1318;
_j1317.textContent = _j846;
if (_j1451 || parseInt(_j1250.value) > _j1318) {
_j1250.value = _j1318;
}
const _j1319 = parseInt(_j1250.value) || 0;
_j1252.textContent = _j1319;
_j1253.textContent = _j1319;
}
_j146();
_j1250.addEventListener('input', (e) => {
const value = parseInt(e.target.value) || 0;
_j1252.textContent = value;
_j1253.textContent = value;
let gridParams = null;
let points = null;
if (typeof _j532 !== 'undefined' && Array.isArray(_j532) && _j532.length > 0) {
const _j1320 = Math.max(0, Math.min(value, _j532.length - 1));
const selectedStroke = _j532[_j1320];
...
let _j1321 = 0;
setInterval(() => {
const _j1322 = (typeof _j532 !== 'undefined' && Array.isArray(_j532)) ?
_j532.length :
0;
if (_j1322 !== _j1321) {
const _j513 = _j1322 > _j1321;
_j146(_j513);
_j1321 = _j1322;
}
}, 500);
...
let _j1169 = _j1180.value.trim();
if (!_j1169 || !/^#[0-9A-Fa-f]{6}$/.test(_j1169)) {
_j1169 = _j1179.value;
}
const r = parseInt(_j1169.slice(1, 3), 16);
const g = parseInt(_j1169.slice(3, 5), 16);
const b = parseInt(_j1169.slice(5, 7), 16);
...
_j122();
_j1179.value = _j1169.toUpperCase();
_j1180.value = _j1169.toUpperCase();
...
_j1167.value = _j1169.toUpperCase();
_j1168.value = _j1169.toUpperCase();
...
const _j1325 = parseInt(_j1171.value);
if (isNaN(_j1324) || isNaN(_j1325)) {
...
if (_j1324 < 100 || _j1324 > 4000 || _j1325 < 100 || _j1325 > 4000) {
...
let _j1327 = null;
function _j149() {
const _j1328 = document.querySelectorAll('.flow-effect-btn');
const _j1329 = document.getElementById('flow-strength');
const _j1330 = document.getElementById('flow-strength-value');
if (_j1329 && _j1330) {
_j1329.addEventListener('input', (e) => {
const value = parseFloat(e.target.value);
_j1330.textContent = value;
if (typeof _j560 !== 'undefined') {
_j560.blendVol = value;
}
});
}
const _j1331 = document.getElementById('flow-last-stroke-only');
if (_j1331) {
...
if (_j1326) {
const blendType = parseInt(_j1326.dataset.type);
_j151(_j1326, blendType);
}
});
}
...
console.log('🎬 Recording flow start event:', _j1332);
_j168('flow', _j1332);
}
_j1327 = setInterval(() => {
const _j864 = document.getElementById('flow-iteration-count');
...
if (_j1326 !== btn) return;
btn.classList.remove('active', 'running');
_j1326 = null;
if (_j1327) {
clearInterval(_j1327);
_j1327 = null;
}
let _j1333 = null;
...
if (typeof _j168 === 'function' && typeof _j582 !== 'undefined' && _j582 && _j1333) {
const _j1334 = {
action: 'end',
blendType: blendType,
flowSeed: (typeof _j552 !== 'undefined') ? _j552 : 0,
duration: _j1333.duration,
iterations: _j1333.iterations,
totalFrames: _j1333.frames
};
console.log('🎬 Recording flow end event:', _j1334);
_j168('flow', _j1334);
...
BlendType: blendType,
Duration: _j1333 ? Math.round(_j1333.duration) + 'ms' : 'unknown',
Iterations: _j1333 ? _j1333.iterations : 'unknown',
Frames: _j1333 ? _j1333.frames : 'unknown'
});
}
let _j1335 = {
enabled: true,
...
_frLen: 0,
_frSum: 0,
_pushFR: function(_j1452) {
if (this._frLen === 60) {
this._frSum -= this._frBuf[this._frIdx];
} else {
this._frLen++;
}
this._frBuf[this._frIdx] = _j1452;
this._frSum += _j1452;
...
if (this._frLen > 0) {
const _j1336 = this._avgFR();
console.log('平均 frameRate:', _j1336.toFixed(2));
console.log('是否触发警告:', _j1336 < this.frameRateThreshold ? '是' : '否');
} else {
console.log('⚠️ 历史记录为空，可能需要等待几秒');
}
console.log('性能数据:', this.performanceData);
console.log('累积数据:', this.performanceDataAccumulated);
const _j1337 = this.logCooldown;
this.logCooldown = 0;
const _j1338 = this._frLen > 0 ?
this._avgFR() :
(() => {
try {
return frameRate();
...
console.log('强制触发检查，使用平均帧率:', _j1338.toFixed(2));
_j33(_j1338);
this.logCooldown = _j1337;
},
...
const _j1337 = this.logCooldown;
this.logCooldown = 0;
const _j1339 = this.frameRateThreshold - 10;
console.log('使用测试帧率:', _j1339);
_j33(_j1339);
this.logCooldown = _j1337;
}
};
window.testPerformanceMonitor = function() {
if (typeof _j1335 === 'undefined') {
console.error('❌ performanceMonitor 未定义！请刷新页面。');
return;
}
console.log('✅ performanceMonitor 已定义');
console.log('可用方法:', Object.keys(_j1335).filter(k => typeof _j1335[k] === 'function'));
_j33(50);
};
function _j152() {
...
const _j1342 = String(frameCount + 1).padStart(5, '0');
const filename = `$seed_${_j1342}.png`;
...
function _j167(_j1453) {
return Math.round(_j1453 * 100) / 100;
}
function _j168(type, data = {}) {
if (!_j582) return;
if (_j583 === 0) return;
const _j1343 = typeof recordingData.timeOffset !== 'undefined' ? recordingData.timeOffset : 0;
const _j1344 = _j1343 + (millis() - _j583 - _j587);
const event = {
m: type,
t: Math.round(_j1344),
...data
...
_j100('recording', `${_j1345[type] || '📝'} Event recorded`, {
Type: _j1346[type] || type,
Time: `${_j1344.toFixed(0)}ms`,
...
_j479 = 0;
const _j1347 = seed;
const _j1348 = (typeof _j142 === 'function') ? _j142() : 0;
const _j1349 = (typeof window.metallicStrength !== 'undefined') ?
Math.round(window.metallicStrength * 100) : 85;
const _j1350 = (typeof window.metallicFlowSpeed !== 'undefined') ?
Math.round(window.metallicFlowSpeed * 100) : 200;
const _j1351 = (typeof window.metallicTint !== 'undefined' && Array.isArray(window.metallicTint)) ?
[...window.metallicTint] : [0.72, 0.50, 0.35];
const tintButtons = {
'gold': [0.88, 0.72, 0.52],
...
if (Math.abs(_j1351[0] - rgb[0]) < 0.01 &&
Math.abs(_j1351[1] - rgb[1]) < 0.01 &&
Math.abs(_j1351[2] - rgb[2]) < 0.01) {
_j1352 = type;
break;
}
}
...
shapeType: _j1348,
metallicStrength: _j1349,
metallicFlow: _j1350,
metallicTint: _j1351,
metallicTintType: _j1352
}
};
randomSeed(_j1347);
noiseSeed(_j1347);
...
const _j1353 = recordingData.events.length > 0 ?
...
const _j1355 = JSON.stringify(_j1354, null, 2);
const _j1356 = new Blob([_j1355], {
type: 'application/json'
});
const _j1357 = URL.createObjectURL(_j1356);
const _j1358 = document.createElement('a');
const timestamp = new Date().toISOString().replace(/[:.]/g, '-').slice(0, -5);
_j1358.download = `drawing-recording-${timestamp}.json`;
_j1358.href = _j1357;
_j1358.click();
URL.revokeObjectURL(_j1357);
_j100('art', '💾 Art recording saved', {
File: _j1358.download,
Size: `${(_j1355.length / 1024).toFixed(2)} KB`,
Events: `${recordingData.events.length} events`,
...
const _j1292 = event.target.files[0];
if (!_j1292) return;
const _j1135 = new FileReader();
_j1135.onload = (e) => {
try {
...
window.loadedRecordingFileName = _j1292.name;
}
recordingData = loadedData;
if (typeof _j532 !== 'undefined') {
_j532 = [];
...
const _j1359 = _j178(recordingData.canvasSize.width, recordingData.canvasSize.height);
if (_j1359) {
...
sessionStorage.setItem('pendingLoadedRecordingFileName', _j1292.name);
return;
}
}
if (recordingData.canvasBackgroundColor && Array.isArray(recordingData.canvasBackgroundColor) && recordingData.canvasBackgroundColor.length === 3) {
...
const _j1360 = window.location.search || '';
const _j1361 = (key) => _j1360.includes('_' + key + ':') || _j1360.includes('?' + key + ':');
const _j1362 = [
...
const _j1364 = recordingData.initialPanelToggles;
for (const _j1365 of _j1362) {
const urlKey = _j1363[_j1365.jsonKey];
if (urlKey && _j1361(urlKey)) continue;
const value = _j1364 ? _j1364[_j1365.jsonKey] : undefined;
const _j1366 = value !== undefined ? value : _j1365.defaultVal;
_j1365.setter(_j1366);
const _j1367 = document.getElementById(_j1365.toggleId);
if (_j1367) {
_j1367.checked = _j1365.isNumeric ? (_j1366 === 1) : !!_j1366;
}
}
_j153();
if (recordingData.canvasBackgroundColor && Array.isArray(recordingData.canvasBackgroundColor) && recordingData.canvasBackgroundColor.length === 3) {
...
const _j1148 = ['Black ⚫', 'White ⚪', 'Red 🔴'];
_j100('playback', 'Brush color restored', {
Mode: _j1148[brushColorMode] || 'Unknown'
});
...
const _j1306 = document.getElementById('metallic-strength-value');
if (_j1305 && _j1306) {
_j1305.value = ec.metallicStrength;
_j1306.textContent = ec.metallicStrength;
}
}
...
const _j1308 = document.getElementById('metallic-flow-value');
if (_j1307 && _j1308) {
_j1307.value = ec.metallicFlow;
_j1308.textContent = ec.metallicFlow;
}
}
...
const _j1368 = `metal-${ec.metallicTintType}`;
const btn = document.getElementById(_j1368);
if (btn) {
...
const _j1370 = window.location.search || '';
const _j1371 = (key) => _j1370.includes('_' + key + ':') || _j1370.includes('?' + key + ':');
for (const _j1365 of _j1369) {
if (_j1371(_j1365.urlKey)) continue;
_j1365.setter(false);
const _j1367 = document.getElementById(_j1365.toggleId);
if (_j1367) {
_j1367.checked = false;
}
const _j1372 = document.getElementById(_j1365.slidersId);
if (_j1372) {
_j1372.style.display = 'none';
}
}
if (typeof distortShowFbmMask !== 'undefined') {
distortShowFbmMask = 0.0;
const _j1373 = document.getElementById('distort-fbm-preview-toggle');
if (_j1373) _j1373.checked = false;
}
...
for (const [oldKey, newKey] of Object.entries(_j1374)) {
...
const _j1375 = document.getElementById('flow-strength');
const _j1376 = document.getElementById('flow-strength-value');
if (_j1375) _j1375.value = fe.flowStrength;
if (_j1376) _j1376.textContent = fe.flowStrength;
}
for (const _j1365 of _j1369) {
const value = fe[_j1365.jsonKey];
if (value === undefined) continue;
if (_j1371(_j1365.urlKey)) {
_j100('playback', `⏭️ Flow Effect: ${_j1365.jsonKey} skipped (URL override)`, {});
continue;
}
_j1365.setter(!!value);
const _j1367 = document.getElementById(_j1365.toggleId);
if (_j1367) {
_j1367.checked = !!value;
}
const _j1372 = document.getElementById(_j1365.slidersId);
if (_j1372) {
_j1372.style.display = value ? 'flex' : 'none';
}
}
if (fe.distortShowFbmMask !== undefined) {
distortShowFbmMask = fe.distortShowFbmMask;
const _j1373 = document.getElementById('distort-fbm-preview-toggle');
if (_j1373) _j1373.checked = fe.distortShowFbmMask > 0.5;
}
if (fe.distortDisplacementB !== undefined) {
distortDisplacementB = fe.distortDisplacementB;
const _j1377 = document.getElementById('distort-displacement-b');
const _j1378 = document.getElementById('distort-displacement-b-value');
if (_j1377) _j1377.value = fe.distortDisplacementB;
if (_j1378) _j1378.textContent = fe.distortDisplacementB;
}
if (fe.distortDisplacementC !== undefined) {
distortDisplacementC = fe.distortDisplacementC;
const _j1379 = document.getElementById('distort-displacement-c');
const _j1380 = document.getElementById('distort-displacement-c-value');
if (_j1379) _j1379.value = fe.distortDisplacementC;
if (_j1380) _j1380.textContent = fe.distortDisplacementC;
}
...
Paper: _j1364.showPaperTexture ? 'ON' : 'OFF',
Grid: _j1364.showGridOverlay ? 'ON' : 'OFF',
Path: _j1364.showFuturePathPreview ? 'ON' : 'OFF',
Console: _j1364.screenText ? 'ON' : 'OFF',
Camera: _j1364.doMoving ? 'ON' : 'OFF',
Loop: _j1364.loopToggle === 1 ? 'ON' : 'OFF'
});
} else {
...
_j159();
_j156();
const _j1381 = recordingData.events[0];
if (_j1381 && _j1381.strokeData) {
const strokeData = _j1381.strokeData;
...
_j604.setCenter(_j390, 0);
_j604.setDistance(_j393, 0);
const _j1382 = _j604.getCenter();
const _j1383 = _j604.getDistance();
_j100('system', '📊 After force reset - Camera position logged', {
Center: `[${_j1382[0].toFixed(2)}, ${_j1382[1].toFixed(2)}, ${_j1382[2].toFixed(2)}]`,
Distance: _j1383.toFixed(2)
});
}
_j617 = false;
}
...
const _j1384 = _j512;
const _j1385 = event.t !== undefined ? event.t : event.time;
if (_j512) {
const _j725 = _j591;
if (window._fxVirtualTime === undefined) {
_j591 = millis() - _j1385 / _j593;
}
const _j1386 = _j725 - _j591;
...
const _j1387 = _j1385 - playbackLastStrokeEndEventTime;
const _j1388 = event.strokeData ? event.strokeData.brushMode : brushMode;
const _j1389 = typeof playbackLastStrokeBrushMode !== 'undefined' ? playbackLastStrokeBrushMode : 'unknown';
}
_j36();
if (typeof _j997 !== 'undefined') {
_j997 = [];
...
const offsetX = typeof _j602 !== 'undefined' ? _j602 : 0;
const offsetY = typeof _j603 !== 'undefined' ? _j603 : 0;
const _j1390 = event.x + offsetX;
const _j1391 = event.y + offsetY;
_j100('playback', 'Reproducing', {
Seed: sd.strokeSeed,
Mode: `Brush mode ${sd.brushMode}`,
Color: whiteBrushMode ? "White ⚪" : "Black ⚫",
Position: `(${_j1390.toFixed(0)}, ${_j1391.toFixed(0)})`
});
_j100('system', '|--------------------------------', {});
} else {
...
if (_j515) window._playbackPenPressure = -1;
const _j770 = crandom.getCount();
const _j1392 = event.t !== undefined ? event.t : event.time;
...
playbackLastStrokeEndEventTime = _j1392;
}
if (typeof playbackStrokeIndex !== 'undefined') {
playbackStrokeIndex++;
}
crandomDebugger.checkpoint('播放_mouseReleased', 'mouseReleased');
const _j1393 = crandom.getCount();
const _j775 = _j1393 - _j770;
const _j1394 = typeof playbackStrokeIndex !== 'undefined' ? playbackStrokeIndex : '?';
...
'?';
const _j776 = window.drawLoopCount || 0;
const _j1395 = window.playbackMouseDraggedCount || 0;
console.log(`🎬 播放 [第 ${_j1394}/${_j804} 筆] | Draw: ${_j776} | Seed: ${_j1393}`);
window.drawLoopCount = 0;
window.playbackMouseDraggedCount = 0;
window.playbackMultiEventFrames = 0;
window.playbackDelayedReleaseCount = 0;
crandomDebugger.saveStroke('playback', _j1394);
crandomDebugger.compareStroke(_j1394);
_j594 = event.x + (typeof _j602 !== 'undefined' ? _j602 : 0);
_j595 = event.y + (typeof _j603 !== 'undefined' ? _j603 : 0);
_j598 = false;
if (!_j512) {
...
const _j1396 = action === 'scan-global' ? 'GLOBAL' : 'EACH';
const _j1397 = event.shapeType !== undefined ? event.shapeType : null;
const scanSeed = event.scanSeed !== undefined ? event.scanSeed : null;
const _j1315 = event.bugsSize !== undefined ? event.bugsSize : 10.0;
if (typeof window !== 'undefined') {
window.bugsSize = _j1315;
const _j761 = document.getElementById('bugs-size');
const _j762 = document.getElementById('bugs-size-value');
if (_j761 && _j762) {
_j761.value = _j1315;
_j762.textContent = _j1315;
}
}
const _j760 = {
action: action,
...
_j1398 = window._scanGlobalPlaybackCount || 0;
_j1399 = window._scanCurrentPlaybackCount || 0;
} else {
if (typeof window !== 'undefined') {
window.bugsSize = _j1315;
}
...
if (typeof _j18 === 'function') {
if (action === 'scan-global') {
_j18(null, null, _j1397);
} else if (action === 'scan-current') {
const scanBounds = event.scanBounds || null;
_j18(null, scanBounds, _j1397);
}
}
if (_j763) {
randomSeed(_j763);
...
Mode: _j1396,
ShapeType: _j1397 !== null ? _j1397 : 'Unknown',
BugsSize: _j1315,
Action: action,
...
const _j1306 = event.value !== undefined ? event.value : 85;
if (typeof window !== 'undefined') {
window.metallicStrength = _j1306 / 100;
}
const _j1305 = document.getElementById('metallic-strength');
const _j1400 = document.getElementById('metallic-strength-value');
if (_j1305 && _j1400) {
_j1305.value = _j1306;
_j1400.textContent = _j1306;
}
_j100('playback', '✨ Effect Control: Metallic Strength', {
Value: _j1306
});
} else if (action === 'bugs-size') {
const _j1315 = event.value !== undefined ? event.value : 10;
const _j761 = document.getElementById('bugs-size');
const _j762 = document.getElementById('bugs-size-value');
if (_j761 && _j762) {
_j761.value = _j1315;
...
const _j1308 = event.value !== undefined ? event.value : 200;
if (typeof window !== 'undefined') {
window.metallicFlowSpeed = _j1308 / 100;
}
const _j1307 = document.getElementById('metallic-flow');
const _j1401 = document.getElementById('metallic-flow-value');
if (_j1307 && _j1401) {
_j1307.value = _j1308;
_j1401.textContent = _j1308;
}
...
const _j1402 = window.pendingFlowEvent;
if (_j1402) {
...
const _j1403 = 200;
if (typeof window !== 'undefined') {
const _j1404 = window.pendingEffectControlScanQueue && window.pendingEffectControlScanQueue.length > 0;
if (window.lastEffectControlProcessTime) {
const _j1405 = millis() - window.lastEffectControlProcessTime;
if (_j1405 < _j1403) {
return;
} else {
...
if (_j1404 && !window.lastEffectControlProcessTime) {}
}
if (isWaitingToLoop) {
const _j1406 = millis() - _j599;
const _j1407 = Math.floor(_j1406 / 1000);
if (!window._lastLoggedWaitSecond || window._lastLoggedWaitSecond !== _j1407) {}
if (_j1406 >= loopWaitDuration) {
...
var _j1408 = _j621 + 500;
console.log('[fxhash] Waiting ' + _j1408 + 'ms for camera reset before capture...');
setTimeout(_j175, _j1408);
} else {
_j175();
}
}
...
let _j1413 = false;
while (_j592 < recordingData.events.length && _j1409 < _j1410) {
if (typeof _j547 !== 'undefined' && _j547 &&
...
const _j813 = event.m || event.type;
const _j1414 = _j813 === 'mp' || _j813 === 'mousePressed';
const _j1415 = _j813 === 'mr' || _j813 === 'mouseReleased';
const _j1416 = _j813 === 'ec' || _j813 === 'effectControl';
const _j1417 = _j813 === 'flow';
const _j731 = eventTime - _j730;
if (!_j1416 && !_j1417 && eventTime > _j730 && _j592 + 1 < recordingData.events.length) {
...
if (eventTime <= _j730) {
const _j1418 = _j813 === 'md' || _j813 === 'mouseDragged';
if (_j1418 && _j1411 >= _j1412) {
break;
}
if (_j1415 && _j1413) {
...
if (_j1416 || _j1417 || (_j1414 && !_j512) || _j731 < 100) {
if (_j1416) {
const action = event.action;
if (action === 'scan-global' || action === 'scan-current') {
if (typeof window !== 'undefined') {
...
const _j1419 = (typeof window !== 'undefined' && window.skipContinueRecordingDialog) ||
...
null);
const _j1420 = (typeof window !== 'undefined' && window.loadedRecordingFileName) ?
...
const _j1422 = loadedData.events[loadedData.events.length - 1];
const _j1353 = _j1422.t !== undefined ? _j1422.t : (_j1422.time !== undefined ? _j1422.time : 0);
_j582 = true;
_j583 = millis();
_j585 = 0;
_j587 = 0;
...
Target: `${_j1454}x${_j1455}`,
Action: 'Auto-reloading page to restore canvas size'
});
sessionStorage.setItem('pendingCanvasWidth', _j1454.toString());
sessionStorage.setItem('pendingCanvasHeight', _j1455.toString());
sessionStorage.setItem('pendingRecordingData', JSON.stringify(recordingData));
sessionStorage.setItem('shouldAutoPlay', 'true');
_j100('system', '🔄 Reloading page to restore canvas size...', {
TargetSize: `${_j1454}x${_j1455}`
});
window.location.reload();
return true;
}